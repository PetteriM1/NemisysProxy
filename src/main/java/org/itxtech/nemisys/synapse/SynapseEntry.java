    ...
    public void handleDataPacket(SynapseDataPacket pk) {
        switch (pk.pid()) {
            ...
            case SynapseInfo.PLAYER_LOGIN_PACKET:
                ...
                SynapsePlayerCreationEvent ev = new SynapsePlayerCreationEvent(this.synLibInterface, SynapsePlayer.class, SynapsePlayer.class, ThreadLocalRandom.current().nextLong(), playerLoginPacket.address, playerLoginPacket.port);
