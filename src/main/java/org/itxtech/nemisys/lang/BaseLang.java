...
public class BaseLang {
    ...
    public BaseLang(String lang, String path, String fallback) {
        this.lang.put("disconnectionScreen.invalidSkin", "Invalid skin!");
        this.lang.put("disconnectionScreen.notAuthenticated", "Not authenticated!");
    }
    ...
    public String translateStringI(String str) {
        return this.lang.getOrDefault(str, str);
    }
