 ...
 * <li><b>main</b><br>
 * 字符串，表示这个插件的主类。插件的主类<i>不能放在“org.itxtech.nemisys”包下</i>。<br>
 * String, the main class of plugin. The main class<i> can't be placed at 'org.itxtech.nemisys' package</i>.</li>
